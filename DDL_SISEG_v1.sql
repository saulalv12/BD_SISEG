...
CREATE TABLE ALUMNO(
    ...
    FOREIGN KEY (PLAZA) REFERENCES PLAZA(SEDE)
);
...
CREATE TABLE CODIGO_QR(
    ...
    FOREIGN KEY (ALUMNO) REFERENCES ALUMNO(BOLETA),
    FOREIGN KEY (ADMIN_LECTOR) REFERENCES ADMIN(BOLETA)
);
...
CREATE TABLE REPORTE(
    ...
    PRIMARY KEY (ALUMNO, ID),
    FOREIGN KEY (ALUMNO) REFERENCES ALUMNO(BOLETA),
    FOREIGN KEY (ADMIN_ENCARGADO) REFERENCES ADMIN(BOLETA)
);
...
CREATE TABLE PLAZA(
    ...
    SECCION VARCHAR(50), 
    SEDE VARCHAR(50), -- Nombre del hospital
